...
export function cityKit(renderer){
 ...
 const assets={};source.traverse(o=>{if(o.isMesh){const m={geometry:o.geometry,material:o.material,pool:[],used:0,count:o.geometry.attributes.position.count};renderer.meshes.add(m);assets[o.name]=m;}});
